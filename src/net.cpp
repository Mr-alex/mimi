...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "mimicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.mimicoin.org", "seed1.mimicoin.org"},
    {"seed2.mimicoin.org", "seed2.mimicoin.org"},
    {"seed3.mimicoin.org", "seed3.mimicoin.org"},
    {"seed4.mimicoin.org", "seed4.mimicoin.org"},
	{"seed5.mimicoin.org", "seed5.mimicoin.org"},
    {"seed6.mimicoin.org", "seed6.mimicoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. mimicoin is probably already running."), addrBind.ToString().c_str());
        else
